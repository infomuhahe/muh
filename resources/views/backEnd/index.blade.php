        ...
        <div class="panel"><!-- panel begin -->
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <img src="admin_images/" alt="" class="rounded img-responsive">
...
@endsection
@section('jsblock')        
    <script src="{{asset('admin/js/jquery-331.min.js')}}"></script>     
    <script src="{{asset('admin/js/bootstrap-337.min.js')}}"></script>               
@endsection